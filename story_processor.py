...
def main():
    ...
    parser.add_argument("--format", type=str, choices=["alpaca", "chatml", "completion", "raw_text"], default="alpaca", 
                        help="Output format type (alpaca, chatml, completion, or raw_text)")
